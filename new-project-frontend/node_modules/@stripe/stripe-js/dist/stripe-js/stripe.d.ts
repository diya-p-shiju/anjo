import * as api from '@stripe/stripe-js/dist/api';
import * as paymentIntents from '@stripe/stripe-js/dist/stripe-js/payment-intents';
import * as setupIntents from '@stripe/stripe-js/dist/stripe-js/setup-intents';
import * as confirmationTokens from '@stripe/stripe-js/dist/stripe-js/confirmation-tokens';
import * as orders from '@stripe/stripe-js/dist/stripe-js/orders';
import * as tokens from '@stripe/stripe-js/dist/stripe-js/token-and-sources';
import * as elements from '@stripe/stripe-js/dist/stripe-js/elements';
import * as financialConnections from '@stripe/stripe-js/dist/stripe-js/financial-connections';
import * as ephemeralKeys from '@stripe/stripe-js/dist/stripe-js/ephemeral-keys';
...
import {CheckoutLocale, RedirectToCheckoutOptions} from '@stripe/stripe-js/dist/stripe-js/hosted-checkout';
import {PaymentRequestOptions, PaymentRequest} from '@stripe/stripe-js/dist/stripe-js/payment-request';
import {StripeElement, StripeElementLocale} from '@stripe/stripe-js/dist/stripe-js/elements-group';
import {StripeCheckoutOptions, StripeCheckout} from '@stripe/stripe-js/dist/stripe-js/checkout';
import {
  StripeEmbeddedCheckoutOptions,
  StripeEmbeddedCheckout,
} from '@stripe/stripe-js/dist/stripe-js/embedded-checkout';
